...
export const pricingFeatures = {
  ro: {
    starter: [
      ...
      "Google Analytics",
      "SEO de bază",
      "Configurare deployment și hosting incluse",
      "1 lună suport după lansare",
    ],
    business: [
      "Până la 5 pagini (paginile suplimentare implică costuri adiționale)",
      "Pagină de servicii",
      "Secțiune portofoliu / proiecte",
      "Secțiune testimoniale",
      "Secțiune FAQ",
      "SEO local avansat",
      "Optimizare viteză (bazată pe rezultatele PageSpeed Insights)",
      "Configurare blog",
      "Formular avansat de cerere ofertă",
      "Optimizare profil Google Business",
      "Analiză de bază a competiției",
  ...
  en: {
    ...
    business: [
      "Up to 5 pages (more will generate additional costs)",
      "Services page",
      "Portfolio / Projects section",
      "Testimonials section",
      "FAQ section",
      "Advanced local SEO",
      "Speed optimization (based on PageSpeed Insights results)",
      "Blog setup",
