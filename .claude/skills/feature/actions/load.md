...
1. Check $ARGUMENTS (after "load"):
   ...
   - If it's multiple words: Use as inline feature description and you should generate goals
   - If empty:show: Error - "load" requires a spec filename or feature description

2. Update current-feature.md:
   - Update <H1></H1> heading to include feature name (e.g., `# Current Feature: Add Navbar`)
